...
public class ZinioWebTest {
    ...
    @Test(enabled = false)
    public void TC001_Verify_that_user_can_create_new_account_successfully() {
    ...
    @Test
    public void TC002_Verify_that_user_can_login_successfully() {
    ...
    @Test
    public void TC003_Verify_that_user_can_search_for_magazines_successfully() {
